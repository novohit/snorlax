...
public class DeduplicationContextHolder {
    private static final Map<String, DeduplicationBuilder> builderHolder = new CaseInsensitiveMap<>(4);

    private static final Map<String, DeduplicationService> deduplicationServiceHolder = new CaseInsensitiveMap<>(4);
